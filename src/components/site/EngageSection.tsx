    ...
    <Section id={SECTION.engage}>
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
        ...
        <figure className="lg:order-first">
          <div className="flex justify-center rounded-xl bg-tint p-8 md:p-12">
            <PhoneFrame className="w-[240px]">
              <EngagePlaceholder />
            </PhoneFrame>
          </div>
          <figcaption className="mt-4 text-center text-[13px] text-muted">{home.engage.caption}</figcaption>
        </figure>
      </div>
    </Section>
  )
